                    ...
                    if (shouldClosePosition):
                        ...
                        match cause:
                            ...
                            case "TP Hit":
                                ...
                                if len(insight.TP) > 1:
                                    currentTP = self.insights[symbol][i].TP.pop(
                                        0)
                                    ...
                                    if closeOrder:
                                        ...
                                        self.insights[symbol][i].updateState(InsightState.FILLED, f"Partial TP Hit: {insight.side:^8}: {insight.limit_price} -> {insight.TP[0]} -> {
